    ...
    AdminSerialComponent.prototype.submitSerialForm = function () {
        ...
        this.serialService.generateSerialNo(this.serialForm.value).subscribe(function (response) {
            if (response.code) {
                ...
                _this.serialService.updateSerials(response);
...
var SerialAuthService = /** @class */ (function () {
    ...
    SerialAuthService.prototype.updateSerials = function (serials) {
        var _this = this;
        this.serials.subscribe(function (response) {
            var serialSource = response;
            console.log(serialSource);
            serialSource.splice(0, 0, serials);
            console.log(serialSource);
            _this.serialSource.next(serialSource);
        });
