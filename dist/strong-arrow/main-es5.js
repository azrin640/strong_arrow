...
var AdminMessageTableComponent = /** @class */ (function () {
    function AdminMessageTableComponent(messageService) {
    ...
    AdminMessageTableComponent.prototype.ngOnInit = function () {
    };
    AdminMessageTableComponent.prototype.updateTable = function () {
        var _this = this;
        this.messageService.messages.subscribe(function (response) {
            console.log(response);
            _this.dataSource.data = response;
        });
    };
    AdminMessageTableComponent.prototype.ngAfterViewInit = function () {
    ...
    return AdminMessageTableComponent;
}());
...
/* harmony import */ var _admin_admin_message_admin_message_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./admin/admin-message/admin-message.component */ "./src/app/admin/admin-message/admin-message.component.ts");
...
var routes = [
    ...
    { path: 'admin/message', component: _admin_admin_message_admin_message_component__WEBPACK_IMPORTED_MODULE_10__["AdminMessageComponent"], canActivate: [_services_auth_guard_auth_guard_service__WEBPACK_IMPORTED_MODULE_8__["AuthGuardService"], _services_admin_auth_guard_admin_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__["AdminAuthGuardService"]] },
    // Wildcard routes
    { path: '**', component: _home_home_component__WEBPACK_IMPORTED_MODULE_3__["HomeComponent"] },
];
...
var FooterComponent = /** @class */ (function () {
    function FooterComponent(iconRegistry, sanitizer, router, profileService, snackBar) {
    ...
    FooterComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.profileService.profile.subscribe(function (response) { return _this.profile = response; });
        this.profileService.location.subscribe(function (response) {
            ...
            _this.contact = localAgent;
        });
    };
    FooterComponent.prototype.useContactForm = function () {
...
var NavigationComponent = /** @class */ (function () {
    function NavigationComponent(profileService, snackBar, router) {
        this.profileService = profileService;
        this.snackBar = snackBar;
        this.router = router;
        this.profile = null;
    ...
    NavigationComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.profileService.profile.subscribe(function (response) { return _this.profile = response; });
        this.profileService.location.subscribe(function (response) { if (response)
            _this.snackBar.open("Hello friend from: " + response, 'X', { duration: 10000, panelClass: 'gold-theme' }); });
    }; //
    NavigationComponent.prototype.backToHome = function () { this.router.navigate([''], { fragment: 'top' }); }; //
    NavigationComponent.prototype.logOut = function () { this.profileService.logout(); };
...
var MessageService = /** @class */ (function () {
    ...
    MessageService.prototype.updateMessages = function () {
        var _this = this;
        this.http.get('/api/contacts/messages').subscribe(function (response) {
            _this.messageSource.next(response);
        }, function (error) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(error); });
    }; //
...
var ProfileService = /** @class */ (function () {
    ...
    ProfileService.prototype.getLocation = function () {
        var _this = this;
        this.http.post('/api/user/location', { location: '' }).subscribe(function (response) { return _this.locSource.next(response.country); }, Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (error) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(error); }));
    };
    ProfileService.prototype.isLoggedIn = function () {
        var _this = this;
        var token = this.token = localStorage.getItem('token');
        token ? this.decodeToken() : function () { return _this.loggedIn = false; };
    };
    ProfileService.prototype.decodeToken = function () {
        var _this = this;
        var token = this.token;
        var jwtHelper = new _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_4__["JwtHelperService"]();
        var user = this.user = jwtHelper.decodeToken(token);
        user ? this.getUserSource() : function () { return _this.decodedToken = false; };
    };
    ProfileService.prototype.getUserSource = function () {
        var _this = this;
        var user = this.user;
        this.http.post('/api/user/profile', { _id: user._id }).subscribe(function (response) {
            if (response && response.id) {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authService.login(this.loginForm.value).subscribe(function (response) {
            if (response && response.id) {
                ...
                _this.profileService.userSource.next(response);
                ...
                _this.snackBar.open('Login not successfull, please check your login name and password', 'X', { duration: 10000, panelClass: 'red-theme' });
