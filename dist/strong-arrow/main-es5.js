    ...
    FooterComponent.prototype.ngOnInit = function () {
        ...
        this.profileService.location.subscribe(function (response) {
            if (response) {
                ...
                _this.telegram = _this.agents.reduce(function (acc, value) {
                    if (value.country = response)
...
var NavigationComponent = /** @class */ (function () {
    function NavigationComponent(profileService, snackBar) {
        this.profileService = profileService;
        this.snackBar = snackBar;
        this.profile = false;
    }
    NavigationComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.profileService.profile.subscribe(function (response) { return (response && response.id) ? function () { _this.profile = true; } : function () { _this.profile = false; }; });
...
var ProfileService = /** @class */ (function () {
    ...
    ProfileService.prototype.getLocation = function () {
        ...
        this.http.post('/api/user/location', { location: '' }).subscribe(function (response) {
            ...
            _this.locSource.next(response.country);
    ...
    ProfileService.prototype.getUserSource = function () {
        ...
        var user = this.user;
        if (user) {
            this.http.post('/api/user/profile', { _id: user.id }).subscribe(function (response) { return _this.userSource.next(response); }, Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (error) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(error); }));
        }
        else
